...
let columns: Columns[];
let analysisPolicyInfo: AnalysisPolicies;
export type DataType = {
  user: CreateUserRetType;
  analysisPolicyInfo: AnalysisPolicies;
};
...
export const seed: TesterSeed<DataType> = {
  up: async (tester) => {
    ...
    analysisPolicyInfo = await tester.analysisPoliciesRepository.save({
    ...
    return { user, analysisPolicyInfo };
  },
  down: async (tester) => {
