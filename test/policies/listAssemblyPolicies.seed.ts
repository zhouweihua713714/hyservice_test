...
let columns: Columns[];
let assemblyPolicies: AssemblyPolicies[];
export type DataType = {
  user: CreateUserRetType;
  normalUser: CreateUserRetType;
  columns: Columns[];
  assemblyPolicies: AssemblyPolicies[]
};
...
export const seed: TesterSeed<DataType> = {
  up: async (tester) => {
    ...
    assemblyPolicies = await tester.assemblyPoliciesRepository.save([{
    ...
    return { user, normalUser, columns, assemblyPolicies };
  },
  down: async (tester) => {
    await tester.columnsRepository.delete({});
    await tester.usersRepository.delete({});
    await tester.assemblyPoliciesRepository.delete({});
  },
};
